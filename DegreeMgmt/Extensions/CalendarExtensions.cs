...
namespace DegreeMgmt.Extensions
{
    /// <summary>
    ...
    public static class CalendarExtensions
    {
        ...
        /// <returns>html文本</returns>
        private static HtmlString GenerateHtml(string name, DateTime? date, string format)
        {
            if (date != null)
            {
                return new HtmlString("<input type=\"text\" id=\"" + name + "\" name=\"" + name 
                    + "\" onfocus=\"WdatePicker({dateFmt:'" + format + "'})\" class=\"Wdate\" value=\""
